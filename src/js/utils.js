...
const CVT = (function() {
  ...
  _.cartesian3Degrees = function(cartesian) {
    var cartesian3 = new Cesium.Cartesian3(cartesian.x, cartesian.y, cartesian.z);  //-2780238.1217587152, 4647694.278024909, 3357658.7093275054
// 转换为椭球坐标（Cartesian3到Cartographic）  
